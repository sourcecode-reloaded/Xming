...
DEFUN_LOCAL_VOID (DrawBuffersARB,
    (void *rend, GLsizei n, const GLenum * bufs),
    (n, bufs))

DEFUN_ALIAS_VOID (DrawBuffersATI, DrawBuffersARB,
...
DEFUN_LOCAL_VOID (VertexAttrib1dARB,
    (void *rend, GLuint index, GLdouble x),
    (index, x))

DEFUN_LOCAL_VOID (VertexAttrib1dvARB,
    (void *rend, GLuint index, const GLdouble * v),
    (index, v))

DEFUN_LOCAL_VOID (VertexAttrib1fARB,
    (void *rend, GLuint index, GLfloat x),
    (index, x))

DEFUN_LOCAL_VOID (VertexAttrib1fvARB,
    (void *rend, GLuint index, const GLfloat * v),
    (index, v))

DEFUN_LOCAL_VOID (VertexAttrib1sARB,
    (void *rend, GLuint index, GLshort x),
    (index, x))

DEFUN_LOCAL_VOID (VertexAttrib1svARB,
    (void *rend, GLuint index, const GLshort * v),
    (index, v))

DEFUN_LOCAL_VOID (VertexAttrib2dARB,
    (void *rend, GLuint index, GLdouble x, GLdouble y),
    (index, x, y))

DEFUN_LOCAL_VOID (VertexAttrib2dvARB,
    (void *rend, GLuint index, const GLdouble * v),
    (index, v))

DEFUN_LOCAL_VOID (VertexAttrib2fARB,
    (void *rend, GLuint index, GLfloat x, GLfloat y),
    (index, x, y))

DEFUN_LOCAL_VOID (VertexAttrib2fvARB,
    (void *rend, GLuint index, const GLfloat * v),
    (index, v))

DEFUN_LOCAL_VOID (VertexAttrib2sARB,
    (void *rend, GLuint index, GLshort x, GLshort y),
    (index, x, y))

DEFUN_LOCAL_VOID (VertexAttrib2svARB,
    (void *rend, GLuint index, const GLshort * v),
    (index, v))

DEFUN_LOCAL_VOID (VertexAttrib3dARB,
    (void *rend, GLuint index, GLdouble x, GLdouble y, GLdouble z),
    (index, x, y, z))

DEFUN_LOCAL_VOID (VertexAttrib3dvARB,
    (void *rend, GLuint index, const GLdouble * v),
    (index, v))

DEFUN_LOCAL_VOID (VertexAttrib3fARB,
    (void *rend, GLuint index, GLfloat x, GLfloat y, GLfloat z),
    (index, x, y, z))

DEFUN_LOCAL_VOID (VertexAttrib3fvARB,
    (void *rend, GLuint index, const GLfloat * v),
    (index, v))

DEFUN_LOCAL_VOID (VertexAttrib3sARB,
    (void *rend, GLuint index, GLshort x, GLshort y, GLshort z),
    (index, x, y, z))

DEFUN_LOCAL_VOID (VertexAttrib3svARB,
    (void *rend, GLuint index, const GLshort * v),
    (index, v))

DEFUN_LOCAL_VOID (VertexAttrib4dARB,
    (void *rend, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w),
    (index, x, y, z, w))

DEFUN_LOCAL_VOID (VertexAttrib4dvARB,
    (void *rend, GLuint index, const GLdouble * v),
    (index, v))

DEFUN_LOCAL_VOID (VertexAttrib4fARB,
    (void *rend, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w),
    (index, x, y, z, w))

DEFUN_LOCAL_VOID (VertexAttrib4fvARB,
    (void *rend, GLuint index, const GLfloat * v),
    (index, v))

DEFUN_LOCAL_VOID (VertexAttrib4sARB,
    (void *rend, GLuint index, GLshort x, GLshort y, GLshort z, GLshort w),
    (index, x, y, z, w))

DEFUN_LOCAL_VOID (VertexAttrib4svARB,
    (void *rend, GLuint index, const GLshort * v),
    (index, v))

DEFUN_LOCAL_VOID (VertexAttrib4NubARB,
    (void *rend, GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w),
    (index, x, y, z, w))

DEFUN_LOCAL_VOID (VertexAttrib4NubvARB,
...
DEFUN_EXTERN (GLuint, GenFragmentShadersATI,
    (GLuint range),
    (range))

DEFUN_EXTERN_VOID (BindFragmentShaderATI,
    (GLuint id),
    (id))

DEFUN_EXTERN_VOID (DeleteFragmentShaderATI,
    (GLuint id),
    (id))

DEFUN_EXTERN_VOID (BeginFragmentShaderATI,
    (),
    ())

DEFUN_EXTERN_VOID (EndFragmentShaderATI,
    (),
    ())

DEFUN_EXTERN_VOID (PassTexCoordATI,
    (GLuint dst, GLuint coord, GLenum swizzle),
    (dst, coord, swizzle))

DEFUN_EXTERN_VOID (SampleMapATI,
    (GLuint dst, GLuint interp, GLenum swizzle),
    (dst, interp, swizzle))

DEFUN_EXTERN_VOID (ColorFragmentOp1ATI,
    (GLenum op, GLuint dst, GLuint dstMask, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod),
    (op, dst, dstMask, dstMod, arg1, arg1Rep, arg1Mod))

DEFUN_EXTERN_VOID (ColorFragmentOp2ATI,
...
DEFUN_EXTERN_VOID (ColorFragmentOp3ATI,
...
DEFUN_EXTERN_VOID (AlphaFragmentOp3ATI,
...
DEFUN_EXTERN_VOID (SetFragmentShaderConstantATI,
...
do { \
    ...
    (d)[475] = (void *) &p ## VertexAttrib1sARB; \
    (d)[476] = (void *) &p ## VertexAttrib1fARB; \
    (d)[477] = (void *) &p ## VertexAttrib1dARB; \
    (d)[478] = (void *) &p ## VertexAttrib2sARB; \
    (d)[479] = (void *) &p ## VertexAttrib2fARB; \
    (d)[480] = (void *) &p ## VertexAttrib2dARB; \
    (d)[481] = (void *) &p ## VertexAttrib3sARB; \
    (d)[482] = (void *) &p ## VertexAttrib3fARB; \
    (d)[483] = (void *) &p ## VertexAttrib3dARB; \
    (d)[484] = (void *) &p ## VertexAttrib4sARB; \
    (d)[485] = (void *) &p ## VertexAttrib4fARB; \
    (d)[486] = (void *) &p ## VertexAttrib4dARB; \
    (d)[487] = (void *) &p ## VertexAttrib4NubARB; \
    (d)[488] = (void *) &p ## VertexAttrib1svARB; \
    (d)[489] = (void *) &p ## VertexAttrib1fvARB; \
    (d)[490] = (void *) &p ## VertexAttrib1dvARB; \
    (d)[491] = (void *) &p ## VertexAttrib2svARB; \
    (d)[492] = (void *) &p ## VertexAttrib2fvARB; \
    (d)[493] = (void *) &p ## VertexAttrib2dvARB; \
    (d)[494] = (void *) &p ## VertexAttrib3svARB; \
    (d)[495] = (void *) &p ## VertexAttrib3fvARB; \
    (d)[496] = (void *) &p ## VertexAttrib3dvARB; \
    (d)[497] = (void *) &p ## VertexAttrib4bvARB; \
    (d)[498] = (void *) &p ## VertexAttrib4svARB; \
    ...
    (d)[503] = (void *) &p ## VertexAttrib4fvARB; \
    (d)[504] = (void *) &p ## VertexAttrib4dvARB; \
    (d)[505] = (void *) &p ## VertexAttrib4NbvARB; \
    (d)[507] = (void *) &p ## VertexAttrib4NivARB; \
    (d)[508] = (void *) &p ## VertexAttrib4NubvARB; \
